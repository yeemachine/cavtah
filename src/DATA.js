...
const DATA = {
  ...
  "annotation":[ //Order in list denotes order of appearance
    <p key="p1">
      <b className="footnote">1</b> e.g. A,”B,”C” in the first volumes of the Rembrandt Research Projects <b>Corpus of Rembrandt Paintings</b>     </p>
  ]
}
